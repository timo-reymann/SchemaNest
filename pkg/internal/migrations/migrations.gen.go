...
func postgres01_initialize_schemaUpSql() (*asset, error) {
	...
	info := bindataFileInfo{name: "postgres/01_initialize_schema.up.sql", size: 559, mode: os.FileMode(420), modTime: time.Unix(1749461768, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
func sqlite301_initialize_schemaUpSql() (*asset, error) {
	...
	info := bindataFileInfo{name: "sqlite3/01_initialize_schema.up.sql", size: 830, mode: os.FileMode(420), modTime: time.Unix(1749461768, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
