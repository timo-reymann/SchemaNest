...
import {CheckIcon, ClockCircleLinearIcon, EyeIcon, LinkIcon} from "@heroui/shared-icons";
    ...
    return (
        <div>
            ...
            {otherSchema && otherVersion ?
                ...
                :
                <p className="text-center">Please select a version to compare the schema with.</p>
            }
...
export default function JsonSchemaVersionPage() {
    ...
    const tabs = [
        ...
        },
        {
            ...
            content: <JsonSchemaViewer content={{}}
                                       schema={schema}
                                       theme={theme!}/>,
        },
        {
