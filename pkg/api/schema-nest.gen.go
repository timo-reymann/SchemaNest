...
type ClientInterface interface {
	...
	// GetNotice request
	GetNotice(ctx context.Context, reqEditors ...RequestEditorFn) (*http.Response, error)
...
func (c *Client) GetNotice(ctx context.Context, reqEditors ...RequestEditorFn) (*http.Response, error) {
	req, err := NewGetNoticeRequest(c.Server)
	if err != nil {
		return nil, err
	}
	req = req.WithContext(ctx)
...
// NewGetNoticeRequest generates requests for GetNotice
func NewGetNoticeRequest(server string) (*http.Request, error) {
	var err error
...
type ClientWithResponsesInterface interface {
	...
	// GetNoticeWithResponse request
	GetNoticeWithResponse(ctx context.Context, reqEditors ...RequestEditorFn) (*GetNoticeResponse, error)
...
// Status returns HTTPResponse.Status
func (r GetNoticeResponse) Status() string {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.Status
	}
	return http.StatusText(0)
...
// StatusCode returns HTTPResponse.StatusCode
func (r GetNoticeResponse) StatusCode() int {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.StatusCode
	}
	return 0
...
// GetNoticeWithResponse request returning *GetNoticeResponse
func (c *ClientWithResponses) GetNoticeWithResponse(ctx context.Context, reqEditors ...RequestEditorFn) (*GetNoticeResponse, error) {
	rsp, err := c.GetNotice(ctx, reqEditors...)
	if err != nil {
		return nil, err
	}
...
// ParseGetNoticeResponse parses an HTTP response from a GetNoticeWithResponse call
func ParseGetNoticeResponse(rsp *http.Response) (*GetNoticeResponse, error) {
	bodyBytes, err := io.ReadAll(rsp.Body)
	defer func() { _ = rsp.Body.Close() }()
	if err != nil {
		return nil, err
...
func HandlerWithOptions(si ServerInterface, options StdHTTPServerOptions) http.Handler {
	...
	m.HandleFunc("GET "+options.BaseURL+"/license", wrapper.GetLicense)
	m.HandleFunc("GET "+options.BaseURL+"/notice", wrapper.GetNotice)
...
var swaggerSpec = []string{
	...
	"H4sIAAAAAAAC/+xYW0/kthf/Kpb//8cMoe2+NG9ToNXsIhZ1FqqK8uBJTiZGie21HWg0ynevfMk9DAzs",
	"ot2qT4SJffy7nHNsZ4djXgjOgGmFox1WcQYFsY9nUnJpHkiSUE05I/ml5AKkpqBwlJJcQYBF76cdhmZO",
	"AiqWVJhpOHKhUAFKkS3gAOtKAI6w0pKyLa7rAEv4XFIJCY5ufJDbdhjf3EGscR3g94qztUV4CprQXB0I",
	"b4BqDPK0+w+lXCKdzUAN8D1IRTmz8f4vIcUR/l/YiRh6BcMO63UzY0y0DbWf64ql3Kz2Oi7IAUNEIQUa",
	"bSr7Y040KI08kjm+NAGmaUphxtdV+260ylwgt5QX4yn1/LBLIvVUtx6kYIBovMh+Xc+p0gYH1VAcYKe1",
	"o24jEylJNQzc43hAct53s/bXx/2z2F338vRAhg3+GZJXqxPOUro9kBsR9ANUy1JnZ4xscsNjnEt/ZKAz",
	"kGh5uUIfoEKk1JmxOSY2izOi0AaAIfABWmwbznMgbCLTdM05wQaJ9hSpIWI/FSkQIImGBFGmOaJaIWHD",
	"jVUoyN1cd1xDQQxRZN9Pa5EyDVuQBm1B2f4I5v3eCILoONsTwb7fE2EksqPUAGvCT4WuA6wgLiXVlc0x",
	"J8jSWmSeNkAkyF+5LIjGEV5erhbmTeA2JGuzHdEhyrQWuDaBqe+PMWeaxLakGbFzPtGCo9+hKggzXEqZ",
	"+4kqCsMt1Vm5OYp5EWpa8IV040JXAxegbH4MZTLJeQopZbRtrb3hAdZU52bhwY9tYWMTkAtgRFAc4Z+O",
	"jo+OnWaZlSMkgi6UgPioKnLzwxYsG27zi3K2SnCEfwO9FHQtIP6zyLGxQwnOlFP0x+PjGXNd509a4E43",
	"VRYFkZULaevOBKWpLzkD1iDyDSK8U5wtfHt/DJtpqe/XHy/W/hgxj84YBUy7xiByv55doDuDPL9dNWcB",
	"S2rEvIxjUCotc9QCxUPuBjIieY7IPaG5aRTIMEDNSah+XIZw1+1E9VN+2Rm9XaS/hwkiSQEapMLRzQ5T",
	"A91kBQ6aTB5seV0BallC0BNsvHHcvokBdiOdUb9pkFZPN/QvWwPvjt9Ns7Q3Cj1QnaGOM2Jco5SXLMHT",
	"xG1OUYiniCDDoTmEPNe6MM4IY5CHO//wcjNPXAD/52taG8wGi9uF3y5Jxq1+kgfn7pDZN7jfi75wPgyP",
	"tC4rehVtmzZBjVDPzhEX9sWJ4TT4lmv9+7LxUOMWveP1Kwy8bg9G32XPHl2r9lrsy6XRbeqQue717Old",
	"J3ueP98nHyrc+YeXN2HP8g28mm/C3en5v+p9rHoDLLia8faSq3+puZ9LUPoXnlSv87WeJMoPU9tOJNgL",
	"ad8+D7w5gf38xZqK+1A4d/r2X5xyCSSp0ANRqBQ5Jwkkgxuh9W3ZXtdxdHNbBzujWpdUjhEiiMFD/5Dn",
	"t/N+lwpzGgNTsK9/nPshT1adhr91KHJC531pLX7J1aNpouerk7OL9RlKaQ6OAeOaxnsJXLgR3wT+i4+f",
	"Vid9+CVdxO1nomHYqxVyr0ofMniU4hX135q+4obYfs+aUcDQm8CdV2BmWF3/EwAA//880Z3GXBcAAA==",
}
